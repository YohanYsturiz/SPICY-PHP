<?php
	include ("mode_conection.php");
	# Muestra el mensaje de confirmación
	$msg="";
	# Verificamos que el formulario no ha sido enviado aun
	$postback = (isset($_POST["enviar"])) ? true : false;
	# Concexión a la base de datos
	$link = pg_connect("host=".$this->servidor." port=".$this->port." password=".$this->clave." user=".$this->user." dbname=".$this->db." ") or die(pg_last_error($link));
