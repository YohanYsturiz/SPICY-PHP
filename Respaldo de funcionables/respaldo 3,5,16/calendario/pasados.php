		...
		<?php
			...
			for ($i=1;$i<=$diasdespues;$i++)
			{
				...
				if ($i>=$primeromes && $i<=$tope) 
				{
					...
					if ($compuesta<date("Y-m-d")) $noform=true; else $noform=false;
